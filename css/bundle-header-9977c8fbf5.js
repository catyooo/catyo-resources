!function (e, t) {
    ...
    var h = function (n) {
        var e, h, b, o, r, p, f, m, w, u, l, T, C, s, E, g, a, c, v, S = "sizzle" + 1 * new Date, y = n.document, A = 0,
            ...
            $ = new RegExp("=" + I + "*([^\\]'\"]*?)" + I + "*\\]", "g"), U = new RegExp(P),
            Y = new RegExp("^" + H + "$"), X = {
                ID: new RegExp("^#(" + H + ")"),
                CLASS: new RegExp("^\\.(" + H + ")"),
                TAG: new RegExp("^(" + H + "|[*])"),
    ...
    It.href = xt.href, S.extend({
        ...
        ajax: function (e, t) {
            ...
            var c, f, d, n, h, i, p, m, r, o, g = S.ajaxSetup({}, t), v = g.context || g,
                y = g.context && (v.nodeType || v.jquery) ? S(v) : S.event, x = S.Deferred(),
                b = S.Callbacks("once memory"), w = g.statusCode || {}, s = {}, a = {}, u = "canceled", T = {
    ...
    function x(e) {
        if (function () {
            ...
            var u = n.paddingLeft + n.paddingRight, l = n.paddingTop + n.paddingBottom,
                c = n.marginLeft + n.marginRight, f = n.marginTop + n.marginBottom,
                d = n.borderLeftWidth + n.borderRightWidth, h = n.borderTopWidth + n.borderBottomWidth, p = i && b,
                m = v(t.width);
    ...
    return c.htmlInit = function (a, u) {
        c.docReady(function () {
            var e = c.toDashed(u), r = "data-" + e, t = document.querySelectorAll("[" + r + "]"),
                n = document.querySelectorAll(".js-" + e), i = c.makeArray(t).concat(c.makeArray(n)),
                o = r + "-options", s = l.jQuery;
    ...
    u.constructor = n, u._create = function () {
        ...
        var e = this.layout.size, t = {}, n = this.layout._getOption("originLeft"),
            ...
            s = n ? "right" : "left", a = this.position.x + e[r];
